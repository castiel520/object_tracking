...
//    std::cout << "r: " << objects[viewIdx][objectIdx]->stepSize[viewIdx]->r << " tX: " << objects[viewIdx][objectIdx]->stepSize[viewIdx]->tX << " tY: " << objects[viewIdx][objectIdx]->stepSize[viewIdx]->tY << " tZ: " << objects[viewIdx][objectIdx]->stepSize[viewIdx]->tZ << std::endl;
//    std::cout << "r: " << presetStepSize->r << " tX: " << presetStepSize->tX << " tY: " << presetStepSize->tY << " tZ: " << presetStepSize->tZ << std::endl;
//    std::cout << "r: " << actualStepSize.r << " tX: " << actualStepSize.tX << " tY: " << actualStepSize.tY << " tZ: " << actualStepSize.tZ << std::endl;
