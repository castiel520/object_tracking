...
public:
  ...
  void SetFrom(VFLOAT tX, VFLOAT tY, VFLOAT tZ, VFLOAT *rotation_matrix) {
    //        printf("[Pose3D/SetFrom] 4 \n");

    this->translation->x = tX;
    this->translation->y = tY;
    this->translation->z = tZ;
    this->rotation->SetFromMatrix(rotation_matrix);

//      std::cout << "t: " << tX << " " << tY << " " << tZ << std::endl;
//      std::cout << "r: " << this->rotation->vector4d.x << " " << this->rotation->vector4d.y << " " << this->rotation->vector4d.z << " " << this->rotation->vector4d.w << std::endl;
  }
